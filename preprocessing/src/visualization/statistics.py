            ...
            if measurement_type == MeasurementType.CPU_STATS:
                for group in groups:
                    ...
                    energy_panel = Statistics._create_combined_stat_panel(
                        experiment_name, group.name, x_pos, y_pos, "CPU_Total_Energy (J)", "Energy")
                    ...
                    power_panel = Statistics._create_combined_stat_panel(
                        experiment_name, group.name, x_pos, y_pos, "CPU_Peak_Power (W)", "Peak Power")
                    ...
                    panels.extend([energy_panel, energy_image_panel, power_panel, power_image_panel])
