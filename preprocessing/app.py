...
configs = [
    VisualizationConfig("Power Analysis", "Power Delta over Time", "csv-data/preprocessing_output/result_processed.csv"),
]
...
def add_config():
    ...
    """
    data = request.form
    new_config = VisualizationConfig(data['name'], data['kind'], data['csv_path'])
